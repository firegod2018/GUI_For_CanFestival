...
from gnosis.xml.pickle.ext._mutate import add_mutator
import sys, string
from types import *
...
add_mutator(mutate_builtin_wrapper())
...
if gnosis.pyconfig.Have_ObjectClass():
    add_mutator(mutate_bltin_instances())
