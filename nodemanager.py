        ...
        if not result:
            ...
            for option in options:
                if option == "DS302":
                    ...
                    # Charging DS-302 "buffer_size":profile if choosen by user
...
#-------------------------------------------------------------------------------
    ...
    def GetProfileLists(self, mappingdictionary, listVar):
        dictionary = {}
        current = []
